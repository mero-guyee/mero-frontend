...
export const MOCK_FOOTPRINTS: Footprint[] = [
  {
    ...
    title: "마추픽추 방문",
    date: "2026-03-15",
    content: "오늘 마추픽추에 왔다. 구름 사이로 보이는 잉카 유적이 정말 환상적이었다. 새벽 4시에 일어나서 버스를 타고 올라왔는데, 일출을 보며 느낀 감동은 말로 표현할 수 없다.",
  ...
  },
  {
    ...
    title: "우유니 소금 사막",
    date: "2026-03-16",
    content: "하늘을 걷는 느낌이다. 끝없이 펼쳐진 하얀 소금 평원에 하늘이 그대로 반사되어, 마치 구름 위를 걷는 것 같았다.",
